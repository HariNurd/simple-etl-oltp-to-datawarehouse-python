...
oltp_conn_string = "postgresql://HariNurd:harinurdnerd0410@localhost:5432/oltp"
warehouse_conn_string = "postgresql://HariNurd:harinurdnerd0410@localhost:5432/datawarehouse"
...
dimension_columns = {
    ...
    "fact_orders": ["order_id", "order_date", "user_id", "payment_id", "shipper_id", "order_price", "order_discount", "voucher_id", "order_total"]
}
